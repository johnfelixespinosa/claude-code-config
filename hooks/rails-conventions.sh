...
if [[ "$file_path" == */app/controllers/*.rb ]]; then
  if skill_loaded "rails-controller-conventions"; then
    allow_with_skill "rails-controller-conventions" "controller"
  else
...
if [[ "$file_path" == */app/models/*.rb ]]; then
  if skill_loaded "rails-model-conventions"; then
    allow_with_skill "rails-model-conventions" "model"
  else
...
if [[ "$file_path" == */app/views/*.erb ]]; then
  if skill_loaded "rails-view-conventions"; then
    allow_with_skill "rails-view-conventions" "view"
  else
    deny_without_skill "rails-view-conventions" "view"
  fi
  exit 0
fi
...
if [[ "$file_path" == */app/helpers/*.rb ]]; then
  if skill_loaded "rails-view-conventions"; then
    allow_with_skill "rails-view-conventions" "helper"
  else
    deny_without_skill "rails-view-conventions" "helper"
  fi
  exit 0
fi
...
if [[ "$file_path" == */app/components/*.rb ]] && [[ "$file_path" != *_controller.js ]]; then
  if skill_loaded "rails-view-conventions"; then
    allow_with_skill "rails-view-conventions" "ViewComponent"
  else
    deny_without_skill "rails-view-conventions" "ViewComponent"
  fi
  exit 0
fi
...
if [[ "$file_path" == */app/components/*_controller.js ]] || [[ "$file_path" == */app/packs/controllers/*_controller.js ]]; then
  if skill_loaded "rails-stimulus-conventions"; then
    allow_with_skill "rails-stimulus-conventions" "Stimulus controller"
  else
    deny_without_skill "rails-stimulus-conventions" "Stimulus controller"
  fi
  exit 0
fi
...
if [[ "$file_path" == */app/policies/*.rb ]]; then
  if skill_loaded "rails-policy-conventions"; then
    allow_with_skill "rails-policy-conventions" "policy"
  else
    deny_without_skill "rails-policy-conventions" "policy"
  fi
  exit 0
fi
...
if [[ "$file_path" == */app/jobs/*.rb ]]; then
  if skill_loaded "rails-job-conventions"; then
    allow_with_skill "rails-job-conventions" "job"
  else
...
if [[ "$file_path" == */db/migrate/*.rb ]]; then
  if skill_loaded "rails-migration-conventions"; then
    allow_with_skill "rails-migration-conventions" "migration"
  else
...
if [[ "$file_path" == */spec/*.rb ]]; then
  if skill_loaded "rails-testing-conventions"; then
    allow_with_skill "rails-testing-conventions" "spec"
  else
